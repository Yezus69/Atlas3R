...
| D-0018 | ViPE import | External ViPE artifacts can be imported through `offline import-vipe`; if ViPE pose export is nonfinite, Atlas3R may import finite dense SLAM map points but must leave trajectory unavailable and report the fallback. | Yes |
