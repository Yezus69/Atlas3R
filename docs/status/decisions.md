...
| D-0018 | RoomGraph optimizer | V1.2 RoomGraph uses real 2D tracks plus VGGT/Depth Pro proposal depths to optimize diagnostic depth, pose, and joint variants; outputs remain unanchored teacher/optimizer geometry and reports must show regressions as well as gains. | Yes |
