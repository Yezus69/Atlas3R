...
Result: official TUM download succeeded on retry, manifest preparation produced
398 frames, CUDA smoke passed, and the overnight CUDA run completed 30,000
steps with required artifacts under ignored `runs/tum_rgbd_freiburg1_xyz_overnight/`.
