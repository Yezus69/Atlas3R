...
1. **Resolution-non-invariant classification metrics** — at the physics-derived 2.5 cm voxel the tolerance-box majority vote (9×9×9) and the count-ratio map fsc structurally tighten (Phase 9: xyz recall-any 0.76 vs voted iou 0.05; raw fsc 0.354@2.5cm vs 0.244@5cm; floor-RANSAC inlier distance halves). A resolution-invariant vote / count-normalized fsc needs its own GT-free pre-registration — never a revision against observed GT.
